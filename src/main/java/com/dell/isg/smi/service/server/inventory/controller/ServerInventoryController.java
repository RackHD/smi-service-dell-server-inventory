...
public class ServerInventoryController {
    ...
    @ApiOperation(value = "/hardware", nickname = "hardware", notes = "This operation allow user to retrieve complete server hardware inventory via the iDRAC using WSMan protocol.", response = ServerHardwareInventory.class)
    ...
    @ApiOperation(value = "/summary", nickname = "summary", notes = "This operation allow user to retrieve server system information (System View) via the iDRAC using WSMan protocol.", response = HwSystem.class)
    ...
    @ApiOperation(value = "/software", nickname = "software", notes = "This operation allow user to retrieve complete server software inventory via the iDRAC using WSMan protocol.", response = DCIMSoftwareIdentityType.class, responseContainer = "List")
    ...
    @ApiOperation(value = "/nics", nickname = "nics", notes = "This operation allow user to retrieve complete server NIC information via the iDRAC using WSMan protocol.", response = HwNic.class, responseContainer = "List")
    ...
    @ApiOperation(value = "/bios", nickname = "bios", notes = "This operation allow user to retrieves the bios details from server via the iDRAC using WSMan protocol.", response = DCIMBIOSConfig.class)
    ...
    @ApiOperation(value = "/boot", nickname = "boot", notes = "This operation allow user to retrieve boot order details from the server via the iDRAC using WSMan protocol.", response = BootOrderDetails.class)
   ...
   public List<InventoryInformation> inventory(@RequestBody DevicesIpsRequest deviceIps) {
    ...
    @ApiOperation(value = "/manager", nickname = "manager", notes = "This operation allow user to retrieve complete DCIM_IDRACCardView, DCIM_iDRACCardString and DCIM_iDRACCardEnumeration via the iDRAC using WSMan protocol.", response = Manager.class)
