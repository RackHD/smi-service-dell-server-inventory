...
public class ServerInventoryController2_0 {
   ...
   public List<InventoryInformation> inventory(@RequestBody DevicesIpsRequest deviceIps) {
    ...
    @ApiOperation(value = "/dcim/{type}", nickname = "dcim", notes = "This operation allow user to retrieve any dcim data based on the passed type  via the iDRAC using WSMan protocol. Type value - DCIM_SystemView:DCIM_ControllerView:DCIM_VirtualDiskView:DCIM_PhysicalDiskView ..etc", response = Object.class, responseContainer = "List")
