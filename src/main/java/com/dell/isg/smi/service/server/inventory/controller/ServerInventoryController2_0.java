...
public class ServerInventoryController2_0 {
    ...
    @ApiOperation(value = "/hardware", nickname = "hardware", notes = "This operation allow user to get complete server hardware inventory using wsman protocol.", response = Object.class)
    ...
    @ApiOperation(value = "/summary", nickname = "summary", notes = "This operation allow user to get server system information (System View) using wsman protocol.", response = Object.class)
    ...
    @ApiOperation(value = "/software", nickname = "software", notes = "This operation allow user to get complete server software inventory using wsman protocol.", response = Object.class, responseContainer = "List")
    ...
    @ApiOperation(value = "/nics", nickname = "nics", notes = "This operation allow user to get complete server nics information using wsman protocol.", response = Object.class, responseContainer = "List")
    ...
    @ApiOperation(value = "/bios", nickname = "bios", notes = "This operation allow user to collects the bios details from server using wsman protocol.", response = Object.class)
    ...
    @ApiOperation(value = "/boot", nickname = "boot", notes = "This operation allow user to collect boot order details from the server using wsman protocol.", response = Object.class)
   ...
   public List<InventoryInformation> inventory(@RequestBody DevicesIpsRequest deviceIps) {
    ...
    @ApiOperation(value = "/callback", nickname = "callback", notes = "This operation allow user to collect all the server inventory using wsman protocol. It uses callback uri to respond once the inventory is collected. Type could be : hardware :nics :software : manager:boot :bios: summary: sellog: lclog", response = ResponseString.class)
    ...
    @ApiOperation(value = "/manager", nickname = "manager", notes = "This operation allow user to get complete DCIM_IDRACCardView, DCIM_iDRACCardString and DCIM_iDRACCardEnumeration using wsman protocol.", response = Object.class)
