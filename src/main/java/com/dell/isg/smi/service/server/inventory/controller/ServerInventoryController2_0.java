...
public class ServerInventoryController2_0 {
    ...
    @ApiOperation(value = "/hardware", nickname = "hardware", notes = "This operation allows a user to retrieve the complete server hardware inventory via the iDRAC using the WSMan protocol.", response = Object.class)
    ...
    @ApiOperation(value = "/summary", nickname = "summary", notes = "This operation allows a user to retrieve the server system information (System View) via the iDRAC using the WSMan protocol.", response = Object.class)
    ...
    @ApiOperation(value = "/software", nickname = "software", notes = "This operation allows a user to retrieve the complete server software inventory via the iDRAC using the WSMan protocol.", response = Object.class, responseContainer = "List")
    ...
    @ApiOperation(value = "/nics", nickname = "nics", notes = "This operation allows a user to retrieve the complete server NIC information via the iDRAC using the WSMan protocol.", response = Object.class, responseContainer = "List")
    ...
    @ApiOperation(value = "/bios", nickname = "bios", notes = "This operation allows a user to retrieve the bios details from server via the iDRAC using the WSMan protocol.", response = Object.class)
    ...
    @ApiOperation(value = "/boot", nickname = "boot", notes = "This operation allows a user to retrieve the boot order details from the server via the iDRAC using the WSMan protocol.", response = Object.class)
    ...
    @ApiOperation(value = "/manager", nickname = "manager", notes = "This operation allows a user to retrieve the complete iDRAC information like DCIM_IDRACCardView, DCIM_iDRACCardString and DCIM_iDRACCardEnumeration via the iDRAC using the WSMan protocol.", response = Object.class)
    ...
    @ApiOperation(value = "/dcim/{type}", nickname = "dcim", notes = "This operation allows a user to retrieve any dcim data based on the passed type  via the iDRAC using the WSMan protocol. Type value - DCIM_SystemView:DCIM_ControllerView:DCIM_VirtualDiskView:DCIM_PhysicalDiskView ..etc", response = Object.class, responseContainer = "List")
