...
public class ServerLogController2_0 {
    ...
    @ApiOperation(value = "/get/{type}", nickname = "getLogs", notes = "This operation allow a user to retrieve the SEL or LC logs from the server via the iDRAC using the WSMan protocol. Type - LC or SEL.", response = Object.class, responseContainer = "List")
