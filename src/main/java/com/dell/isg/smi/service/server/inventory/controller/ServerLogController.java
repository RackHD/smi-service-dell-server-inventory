...
import com.dell.isg.smi.service.server.inventory.mock.lclog.LCLogResponse;
...
public class ServerLogController {
    ...
    @ApiOperation(value = "/get/{type}", nickname = "getLogs", notes = "This operation allows a user to retrieve the SEL or LC logs from the server via the iDRAC using the WSMan protocol. Type - LC or SEL.", response = Object.class, responseContainer = "List")
